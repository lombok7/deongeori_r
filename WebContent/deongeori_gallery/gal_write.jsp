...
<form method="post" action="./gal_wirte_ok.do" enctype="multipart/form-data">
<div id="article">
  ...
  <div id="article_c">
    ...
    <table id="gallery_t">  
     ...
     <input type="hidden" name="dng_gal_writer" id="dng_gal_writer" size="14" value="${id}" class="input_box"/>
       <th> 글내용 </th>
        <td> 
